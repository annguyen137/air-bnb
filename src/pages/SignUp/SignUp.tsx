...
const SignUp = () => {
    ...
    const signupSchema = yup.object().shape({
        ...
        passwordMatch: yup
            .string()
            .required("Please verify your pasword!")
        ...
        birthday: yup
            ...
            .max(
                new Date(),
                `DOB cannot be greater than ${moment(new Date()).format(
                    "YYYY/MM/DD"
                )}`
            )
            .default(new Date()),
    ...
    const onSubmit: SubmitHandler<ISignUpForm> = (value) => {
        dispatch(signup(value));
        signup(value);
    };

    const onError: SubmitErrorHandler<ISignUpForm> = (error) => {
        console.log(error);
