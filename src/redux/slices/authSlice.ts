...
export const login = createAsyncThunk(
    "auth/login",
    async ({ email, password, isRemember }: LoginValue) => {
        try {
...
const authSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(signup.pending, (state) => {
            noti = toast.loading("Signing you up ...!", {
                isLoading: true,
                closeOnClick: false,
            });
